...
Some links:
Factorio calculator: https://kirkmcdonald.github.io/calc.html#data=2-0-55&items=advanced-circuit:f:1

Factorio TAS Mod: 
https://github.com/gotyoke/Factorio-AnyPct-TAS/blob/master/README.md
...
Controlling the player through a mod
